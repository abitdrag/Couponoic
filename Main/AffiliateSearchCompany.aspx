<%@ Page Title="" Language="C#" MasterPageFile="~/AffiliateMasterPage.master" AutoEventWireup="true" CodeFile="AffiliateSearchCompany.aspx.cs" Inherits="AffiliateSearchCompany" %>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="AffiliateHome.aspx">Home</a>
              ...
              <div>
                     ...
                     <div class="control-group">
                           ...
                           <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                            <asp:button ID="Button1" type="submit" class="btn  btn-primary " runat="server" 
                                                        Text="Search" onclick="btnSearch_Click"></asp:button>
                        ...
                        <Columns>
                         <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image1" runat="server" src='<%#Eval("Photo") %>' style="width:100px"/>
                            </ItemTemplate>
                            <ItemStyle Width="10%" />
                        </asp:TemplateField>
